    ...
    return (
        <div className="min-h-screen flex flex-col bg-background">
            ...
            <section className="relative h-screen flex items-center justify-center overflow-hidden">
                    ...
                    >
                        ...
                        <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                            <Link href="/prediction">
                                <Button
                                    size="lg"
                                    className="rounded-full shadow-premium text-base gap-2"
                                >
                ...
                >
                    <span className="text-sm text-primary font-medium mb-2 uppercase tracking-widest">
                        Explore
                    </span>
                        ...
                        >
                            <Card className="h-full hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border-none shadow-premium group">
                                <CardHeader>
                                    ...
                                    <CardTitle className="text-xl text-primary font-ibm-plex-sans">
                                        Hearing Duration Prediction
                                    </CardTitle>
                                    <CardDescription className="text-base mt-2">
                                        Estimate hearing duration to optimize daily cause lists and
                                        allocate appropriate time slots for each matter.
                                    </CardDescription>
                                </CardHeader>
                            </Card>
                        </motion.div>
                        ...
                        >
                            <Card className="h-full hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border-none shadow-premium group">
                                <CardHeader>
                                    ...
                                    <CardDescription className="text-base mt-2">
                                        Estimate adjournment probability based on historical
                                        patterns, party behaviors, and case characteristics.
                                    </CardDescription>
                                </CardHeader>
                            </Card>
                        </motion.div>
                        ...
                        >
                            <Card className="h-full hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border-none shadow-premium group">
                                <CardHeader>
                                    ...
                                    <CardDescription className="text-base mt-2">
                                        Classify cases into Low, Medium and High complexity to
                                        assign appropriate benches and manage workload.
                                    </CardDescription>
                                </CardHeader>
                            </Card>
                        </motion.div>
            ...
            <footer className="border-t border-border bg-white py-8 mt-auto">
                <div className="container mx-auto px-6 text-center text-sm text-foreground/60">
                    &copy; {new Date().getFullYear()} DocketIQ Judicial Decision Support System.
                    Official Platform.
                </div>
            </footer>
        </div>
