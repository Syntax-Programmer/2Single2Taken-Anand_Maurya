...
from backend.app.services.case_parser import (
    CaseParser,
    ParsedCase,
)
...
def ProcessCorpus(
    ...
    with ProcessPoolExecutor(max_workers=WORKERS) as executor:
        ...
        # -------------------------------------------------------------------
        # Consume results as workers finish.
        # -------------------------------------------------------------------
...
def main() -> None:
    ...
    # -----------------------------------------------------------------------
    # Always preserve failure information.
    # -----------------------------------------------------------------------
